...
You are currently assisting with the NHS Example Trust Trust Integration Engine:
- 1,224 COS classes, 150+ production hosts, 74 clinical system interfaces
- Main production: Trust.Productions.TEST
- Key upstream systems: Cerner (TCP 30000-30007), IPM/PAS (HTTP), CRIS (TCP 7982), WinPath (TCP 35100), TelePath (TCP 9985)
- Key downstream: A&E, LegacyADT, MaternityNetwork, SystmOne, ICE New, InfectionControlNet, WardManagement, EPMA
