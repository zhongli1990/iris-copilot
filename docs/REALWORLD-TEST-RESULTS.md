...
Production hosts (78):
- to.eImportClinical Oscopy | EnsLib.HL7.Operation.TCPOperation | Unknown | Disabled
- to.eImportClinical Pathology | EnsLib.HL7.Operation.TCPOperation | Unknown | Disabled
- to.eImportClinical Radiology | EnsLib.HL7.Operation.TCPOperation | Unknown | Disabled
- to.eImportReporting Oscopy | EnsLib.HL7.Operation.TCPOperation | Unknown | Disabled
- to.eImportReporting Radiology | EnsLib.HL7.Operation.TCPOperation | Unknown | Disabled
- Lab ORM Router | En
```
...
Production hosts (78):
- to.eImportClinical Oscopy
- to.eImportClinical Pathology
- to.eImportClinical Radiology
- to.eImportReporting Oscopy
- to.eImportReporting Radiology
- Lab ORM Router
- Osc ORM Router
- Rad ORM Router
- to.Winpath.ORM
- from.Winpath.ORU
- to.CardiologyReporting.ORM
- to.EndoscopyReporting.ORM
- Lab ORU Router
- Rad ORU Router
- To.PACS.ORM
- from.PACS.ORM
