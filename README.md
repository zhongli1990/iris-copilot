...
Built for **NHS Example Trust Trust**, designed to be deployable on **any IRIS HealthConnect instance**.
...
Internal NHS Example Trust Trust. Not for external distribution without authorization.
